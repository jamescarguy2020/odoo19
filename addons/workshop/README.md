# Workshop Workshop Management System
...
1. Copy `workshop_workshop` folder to your Odoo addons directory
...
4. Search for "Workshop Workshop"
5. Click Install
...
# Update module
python odoo-bin -c odoo.conf -d your_database -u workshop_workshop --stop-after-init
```
...
**Models Created:**
- `workshop.customer` - Customer records
- `workshop.vehicle` - Vehicle records
- `workshop.vehicle.brand` - Brand master data
- `workshop.workshop.job` - Workshop jobs
- `workshop.job.labour` - Labour lines
- `workshop.job.parts` - Parts lines
- `vendor.invoice.ocr` - OCR processing records

### Security Groups

- `group_workshop_user` - Workshop User
- `group_workshop_manager` - Workshop Manager
...
Developed for Workshop Workshop Management System
Built on Odoo 19.0
