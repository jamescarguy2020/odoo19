...
class WorkshopCustomer(models.Model):
    ...
    _description = 'Workshop Customer'
    ...
    # Relationships
    vehicle_ids = fields.One2many('workshop.vehicle', 'customer_id', string='Vehicles')
    vehicle_count = fields.Integer(string='Vehicle Count', compute='_compute_vehicle_count')
    job_ids = fields.One2many('workshop.workshop.job', 'customer_id', string='Workshop Jobs')
